 ...
 * @author Tarc
 */
public class SortedArrayList1<T extends Comparable<T>> implements CustomizedArrayListInterface<T> {
    ...
    private void makeRoom(int start)
    {
     ...
     private void makeRoomSorted(int start)
    {
         
         // for(int i=start;i<numberofEntries;i++)
         //  {
              //need to check whether after Start got items or not first..
              //if got need to shift all the items after the start to right..
                 for(int z=numberofEntries;z>start;z--)
        {
            array[z]=array[z-1];//example,item of index 5 = item of index 4
        }
